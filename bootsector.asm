...
; at runtime.
     ...
     SectorsPerCluster     db 		0x01           ; Sectors per Cluster (1 up to 128)
     ...
     SectorsPerTrack       dw 		0x0020         ; Sectors per Track
     SectorsPerHead        dw 		0x0040         ; Sectors per Head
     HiddenSectors         dd 		0x00000000     ; Number of Hidden Sectors from beginning
     TotalSectors     	  dd 		0x00019000     ; Total num of sectors if over 65535 (32 MB)
     BigSectorsPerFAT      dd 		0x00000314     ; Sectors per FAT (used instead in FAT32)
